...
create TABLE IF NOT EXISTS ecomm.users (
	...
	PRIMARY KEY(id),
	CONSTRAINT UN_USER_NAME_IDX UNIQUE(username)
);
...
create TABLE IF NOT EXISTS ecomm.customer (
    ...
    FOREIGN KEY (username)
		REFERENCES ecomm.users(username),
    CONSTRAINT UN_CUST_USERNAME_IDX UNIQUE(username)
);
...
create TABLE IF NOT EXISTS ecomm.store (
        id uuid NOT NULL DEFAULT random_uuid(),
...
insert into ecomm.users (id, username, password, first_name, last_name, email, phone, user_status) 
values('a1b9b31d-e73c-4112-af7c-b68530f38222', 'test1', 'pwd', 'Test', 'User', 'test@user.com', '234234234', 'ACTIVE');

insert into ecomm.customer (id, username) 
values('a1b9b31d-e73c-4112-af7c-b68530f38222', 'test1');

insert into ecomm.users (id, username, password, first_name, last_name, email, phone, user_status) 
values('a1b9b31d-e73c-4112-af7c-b68530f38223', 'test2', 'pwd', 'Test2', 'User2', 'test2@user.com', '234234234', 'ACTIVE');

insert into ecomm.customer(id, username) 
values('a1b9b31d-e73c-4112-af7c-b68530f38223', 'test2');

INSERT INTO ecomm.address 
VALUES ('a731fda1-aaad-42ea-bdbc-a27eeebe2cc0', '9I-999', 'Fraser Suites Le Claridge', 'Champs-Elysees', 'Paris', 'Île-de-France', 'France', '75008');
insert into ecomm.user_address 
values ('a1b9b31d-e73c-4112-af7c-b68530f38222', 'a731fda1-aaad-42ea-bdbc-a27eeebe2cc0');
...
values ('0a59ba9f-629e-4445-8129-b9bce1985d6a','a1b9b31d-e73c-4112-af7c-b68530f38222', 'a731fda1-aaad-42ea-bdbc-a27eeebe2cc0', '618ffaff-cbcd-48d4-8848-a15601e6725b', current_timestamp, 38.14, NULL, NULL, 'CREATED');
